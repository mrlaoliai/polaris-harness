...
类型定义见 `pkg/governance/eval/incident.go`（IncidentStore 接口：GetUnresolvedIncidents/GetIncident/MarkConverted；Incident 字段：ID/Title/TriggerInput/FailedToolCall/SeverityLevel/ExpertAnnotation/Status）。
