...
路由阈值: si < 0.3 → System 1 | 0.3 ≤ si < 0.6 → System 1.5 | si ≥ 0.6 → System 2。阈值由 DynamicDifficultyCalibrator 动态调整。

SurpriseIndex 类型和 Compute/Route 实现见 `pkg/swarm/surprise.go`。
